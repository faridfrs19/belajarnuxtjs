...
<template>
    <section class="flex justify-center py-10">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            <h1 class="text-2xl mb-7 font-medium">Membuat pesanan</h1>
            ...
            <form @submit.prevent="createProduct">
                <div class="mb-6" v-for="(item, index) in formCreateProduct" :key="index">
                    ...
                    <input v-else-if="item.type === 'file'" :type="item.type" :id="item.name" @change="item.value = $event"
                        class="w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none file:bg-blue-600 file:border-none file:px-3 file:py-2 file:text-white file:mr-3"
                ...
                <button type="submit"
                    class="text-white bg-blue-300 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">
